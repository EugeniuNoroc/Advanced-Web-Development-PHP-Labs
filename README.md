...
Метод определяет действие (GET, POST и т.д.)

Сервер отвечает статусом и данными
  4. Откройте инструменты разработчика в вашем браузере (обычно это можно сделать, нажав F12 или правой кнопкой мыши выбрав "Inspect").
  5. Перейдите на вкладку "Network" (Сеть).
  6. Обновите страницу Wikipedia.
  7. Найдите первый запрос к странице, он будет назван как HTTP и изучите следующие аспекты:
    - URL запроса
